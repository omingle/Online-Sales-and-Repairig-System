...
import com.sdlproject.salesandrepair.FilterProductUser;
import com.sdlproject.salesandrepair.R;
import com.sdlproject.salesandrepair.activities.ShopDetailsActivity;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductUser holder, int position) {
        ...
        holder.addToCartTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //check if quantity is below product quantity, and then decide to be added in cart or not
                checkQuantity(modelProduct);
    ...
    private void checkQuantity(ModelProduct modelProduct) {
        int productQuantity = Integer.parseInt(modelProduct.getProductQuantity());
    ...
    private void showQuantityDialog(final ModelProduct modelProduct) {
        ...
        incrementBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Integer.parseInt(productQuantity) > quantity){
                    ...
                    Toast.makeText(context, "Only " + productQuantity + " is in Stock", Toast.LENGTH_SHORT).show();
                }
            }
        });
