...
public class ModelRepairSeller {
    String repairId, productId, repairDescription, repairingCharges, inWarranty, customerEmail, repairStatus, timestamp, repairTo;

    public ModelRepairSeller() {
    }

    public ModelRepairSeller(String repairId, String productId, String repairDescription, String repairingCharges, String inWarranty, String customerEmail, String repairStatus, String timestamp, String repairTo) {
